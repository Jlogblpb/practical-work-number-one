...
Для запуска тестов использовать следующие команды:
 ...
 Виду того что задания повышенной сложности не выполнялись, в директории с тестами в файле settings.go значение переменной FullNextDate должно быть false.
